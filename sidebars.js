  ...
  docs: [
    {
      ...
      items: [
        ...
        'tutorials/getting-started-library',
      ]
    },
    {
      type: 'category',
      ...
      items: [
        {
          ...
          label: 'Developers',
          items: [
            'how-to-guides/developers/development-environment-secrets'
          ],
        },
        {
          type: 'category',
        ...
        },
        {
          ...
          label: 'General',
          items: [
            'how-to-guides/general/cryptocurrency-wallet'
          ],
        },
      ]
    },
      ...
      items: [
        {
          ...
          label: 'Architecture',
          items: [
            'reference/architecture/agent-architecture',
          ],
        },
        {
          type: 'category',
        ...
        },
        {
          ...
          label: 'GRPC',
          items: [
            'reference/grpc/session-management'
          ],
        },
        {
          type: 'category',
          label: 'Keys',
          items: [
            'reference/keys/key-api',
            'reference/keys/cryptography',
          ],
        },
        {
          type: 'category',
          label: 'Vaults',
          items: [
            'reference/vaults/vault-storage',
          ],
        },
        {
          type: 'category',
        ...
        },
        {
          ...
          label: 'Gestalts',
          items: [
            'reference/gestalts/gestalt-graph',
          ],
        },
        {
          type: 'category',
