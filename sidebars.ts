          ...
          items: [
            {
              ...
              items: [
                'reference/polykey-cli/commands/polykey bootstrap',
                'reference/polykey-cli/commands/polykey agent',
                'reference/polykey-cli/commands/polykey nodes',
                'reference/polykey-cli/commands/polykey secrets',
                'reference/polykey-cli/commands/polykey vaults',
                'reference/polykey-cli/commands/polykey keys',
                'reference/polykey-cli/commands/polykey identities',
                'reference/polykey-cli/commands/polykey notifications',
              ],
            }
          ],
        },
